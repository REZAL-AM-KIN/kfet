                        ...
                        <Card style={{borderRadius: '1rem'}}>
                            <Row className="g-0">
                                ...
                                <Col md={6} lg={5} className="d-none d-md-block">
                                    {/*image*/}
                                    <Image src={left_image} fluid alt="login form"
                                ...
                                <Col md={6} lg={7} className="d-flex align-item-center">
                                    <Card.Body className="p-lg-5 p-4 text-black">
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <h5 className="fw-normal mb-3 pb-3" style={{letterSpacing: "1px"}}>Se
                                                Connecter</h5>
                                            ...
                                            <div className="form-outline mb-4">
                                                ...
                                                />
                                                <label htmlFor='username' className="form-label">Nom
                                                    d'Utilisateur</label>
                                            </div>
                                            ...
                                            {/*TODO, redirect*/}
                                            <a className="small text-muted" href="src/old/components/Login#!">a faire
                                                oubli</a>
                                            <Alert variant="danger" ref={errRef}
                                                   show={errMsg ? true : false}>{errMsg}</Alert>
                                        </form>
                                    </Card.Body>
                                </Col>
