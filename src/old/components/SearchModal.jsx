...
function SearchModal(props) {
    ...
    let suggestions = filteredConsommateur.map((line) => {
        return (<Dropdown.Item key={line.id} as={Link} to={"/pg/" + line.id} onClick={() => {
            handleExit()
        }}>{line.bucque + " " + line.fams + " " + line.nom + " " + line.prenom + " " + line.proms}</Dropdown.Item>);
    });
    ...
    return (
        <Modal show={props.show} onHide={() => handleExit()} size="lg" centered
